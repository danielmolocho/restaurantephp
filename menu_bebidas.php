...
$consulta= "SELECT orden_bebida.*, bebidas.* FROM orden_bebida JOIN bebidas ON orden_bebida.bebidas_idbebidas=bebidas.idbebidas 
			WHERE orden_bebida.recibo_idrecibo='$IDMAXIMO' and orden_bebida.estado='ORDEN'";
...
while ($consulta = $resultado->fetch_array(MYSQLI_BOTH))
{
	...
	echo '<td class="thh"><a href="eliminar_ordenbebida.php?Id='.$consulta['idorden_bebida'].'&numero2='.$id2.'" ><input type="submit" class="btn-enviar" value="ELIMINAR" "></td>';
}
...
while ($consulta = $resultado->fetch_array(MYSQLI_BOTH))	
{
$x=$consulta['idbebidas'];
$c=$consulta['precio'];
?>
<div class="producto">
			<center>
				<a href="bebidaorden.php?numero2=<?php echo $x;?>&mesa=<?php echo $id2; ?>&precio=<?php echo $c; ?>"><img src="/img/<?php echo $consulta['imagen'];?>"></a><br>
