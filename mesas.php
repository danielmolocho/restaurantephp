...
<div id="izquierda_m_o">
	<a href="menu_platillos.php?numero2=<?php echo $id2;?>"><input type="button" class="btn-enviar" value=" VER PLATILLOS" ></a>
	<br><br>
...
<a href="enviar_orden.php?numero2=<?php echo $id2;?>"><input type="button" class="btn-enviar" value="enviar orden" ></a>
<H3 align='right'><?php echo "TOTAL:$".$TOTALCOM; ?></H3>
</div>

    <div id="derecha_m_o">
<a href="menu_bebidas.php?numero2=<?php echo $id2;?>"><input type="button" class="btn-enviar" value="VER BEBIDAS" ></a>
<br><br>
<table id="table_cocina"><thead>
<tr>
...
while ($consulta2 = $resultado2->fetch_array(MYSQLI_BOTH))
{
	...
	echo "<td class='thh'>".$consulta2['estado']."</td>";
}
...
<a href="enviar_ordenbebidas.php?numero2=<?php echo $id2;?>"><input type="button" class="btn-enviar" value="enviar orden" ></a>
<H3 align='right'><?php echo "TOTAL:$".$TOTALCOM; ?></H3>
    </div>  
</div>
...
<a href="metodopago.php?numero2=<?php echo $id2;?>"><input type="button" align="center" class="btn-enviar" value="PAGAR" ></a>
</DIV>
</body>
</html>
