...
<header >
    ...
    <form id="frmajax" method="POST" class="form-registrer" >
      ...
      <div class="contenedor">
        ...
        <input type="number"   name="kilos"                id="kilos"                  placeholder="Cantidad en kilos" class="input-100" required>
        <input type="number"   name="limite"                id="limite"                  placeholder="Cantidad en kilos limite" class="input-100" required>
...
$query="SELECT * FROM proveedor where tipo_suministro='comida'";
